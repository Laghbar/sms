        ...
        <div className={`flex gap-3 ${isReply ? 'ml-10 mt-3' : ''}`}>
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="mt-1.5 flex items-center gap-3">
                    {/* Teacher can reply to top-level comments */}
                    {!isReply && (
                        <button
            ...
            <div className="py-10">
                <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6 flex items-start gap-3 rounded-xl border border-indigo-100 bg-indigo-50 px-4 py-3">
                        <svg className="mt-0.5 h-5 w-5 shrink-0 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
